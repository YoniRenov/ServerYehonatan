...
def getassignment3_1():
     user_info = {'First Name:': 'Yehonatan','Last Name:':'Renov','Gender':'Male','Age:':'26','City:':'Beer-Sheva'}
...
def Assignment3_2():
    if request.method == 'POST':
        ...
        if reg_Username in user_dict:
            ...
            new_user = {reg_Username:  [reg_UserEmail,reg_password,reg_Firstname, reg_Lastname,reg_Age,reg_City,reg_FavPlayer]}
